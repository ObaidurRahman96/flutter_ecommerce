                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                BigText(text: "Nutritious burger meal in China"),
                                SizedBox(height:Dimensions.height10),
                                SmallText(text: "With Europiean Caractertistics"),
                                SizedBox(height:Dimensions.height10),
                                Row(
      ...
      child: Stack(
        children: [
          Container(
            ...
            margin: EdgeInsets.only(top:Dimensions.width10, left:Dimensions.width10, right: Dimensions.width10),
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(Dimensions.radius30),
              color: index.isEven ? Color(0xFF69c5df) : Color(0xFF92944cc),
              image: DecorationImage(
                  fit: BoxFit.cover,
          ...
          Align(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: AppColumn(text: "Combo Burger With Drinks",),
              ),
            ),
          )
        ],
